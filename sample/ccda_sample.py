...
ADAPTER_PATH = "/mnt/hdd/chenzh/ccda_ecoli36_model/"
ESM_MAX_LEN  = 1022
...
# —— cos 质心数据
GREEN_FASTA  = "Antitoxin_CcdA.fasta"
RED_FASTA    = "ccda_ecoli_cleaned.fasta"
TARGET_FASTAS= [(GREEN_FASTA, 0.5), (RED_FASTA, 0.5)]

# —— 批大小 / 变异率 / 代数
PROB_BS  = 32
EMB_BS   = 16
MUT_RATE = 0.20
origin   = 'ccdA_complex_pool0.csv'
ec_pick  = 4
epoch    = 100
